...
[Resources for supporting policy change in research institutions in practice: A report from Subgroup 2](https://zenodo.org/records/11529659) is one of the outputs of the [PRO4RS](https://www.rd-alliance.org/groups/rda-resa-policies-in-research-organisations-for-research-software-pro4rs/members/all-members/) Working Group, which is co-convened by the [Research Software Alliance](https://www.researchsoft.org/) (ReSA) and [Research Data Alliance](https://www.rd-alliance.org/) (RDA). The [report](https://zenodo.org/records/11529659) highlights the challenges that the working group is addressing and our motivation for looking at them. It then summarises a variety of existing resources relevant to different stakeholders.
