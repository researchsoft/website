      ...
      text: |
        <div class="d-flex justify-content-center">
         <div class="col-md-8 text-start">
          ...
          - [Contributing](contact) [resources](resources/resa-resources) and [guidelines](guidelines); ideas for [task forces](taskforces), [events](events) and [news](news); or if you have other ideas for ReSA then [let us know](contact). 
